...
const bridge = {
  ...
  bidOpportunity: {
    ...
    readAnnouncement: (opportunityId) => ipcRenderer.invoke('bid-opportunity:read-announcement', opportunityId),
    saveUiState: (payload) => ipcRenderer.invoke('bid-opportunity:save-ui-state', payload),
    importAnnouncement: () => ipcRenderer.invoke('bid-opportunity:import-announcement'),
    importFromTechnicalPlan: () => ipcRenderer.invoke('bid-opportunity:import-from-technical-plan'),
    importFromUrl: (url) => ipcRenderer.invoke('bid-opportunity:import-from-url', url),
    createAnnouncement: (payload) => ipcRenderer.invoke('bid-opportunity:create-announcement', payload),
    updateAnnouncement: (payload) => ipcRenderer.invoke('bid-opportunity:update-announcement', payload),
    deleteAnnouncement: (payload) => ipcRenderer.invoke('bid-opportunity:delete-announcement', payload),
    saveEnterprise: (payload) => ipcRenderer.invoke('bid-opportunity:save-enterprise', payload),
    clear: () => ipcRenderer.invoke('bid-opportunity:clear'),
  },
  bidImprovement: {
    importDocument: (filePath, role) => ipcRenderer.invoke('bid-improvement:import-document', filePath, role),
    getDocument: (documentId) => ipcRenderer.invoke('bid-improvement:get-document', documentId),
    getAllDocuments: () => ipcRenderer.invoke('bid-improvement:get-all-documents'),
    deleteDocument: (documentId) => ipcRenderer.invoke('bid-improvement:delete-document', documentId),
    getOutlineNodes: (documentId) => ipcRenderer.invoke('bid-improvement:get-outline-nodes', documentId),
    updateNodeContent: (nodeId, content) => ipcRenderer.invoke('bid-improvement:update-node-content', nodeId, content),
    getPolishHistory: (nodeId) => ipcRenderer.invoke('bid-improvement:get-polish-history', nodeId),
    savePolishResult: (result) => ipcRenderer.invoke('bid-improvement:save-polish-result', result),
    getWorkspaceState: () => ipcRenderer.invoke('bid-improvement:get-workspace-state'),
    updateWorkspaceState: (patch) => ipcRenderer.invoke('bid-improvement:update-workspace-state', patch),
    clear: () => ipcRenderer.invoke('bid-improvement:clear'),
    bridgeToRejectionCheck: (documentId) => ipcRenderer.invoke('bid-improvement:bridge-to-rejection-check', documentId),
    bridgeToEvaluation: (documentId) => ipcRenderer.invoke('bid-improvement:bridge-to-evaluation', documentId),
    exportDocument: (documentId) => ipcRenderer.invoke('bid-improvement:export-document', documentId),
  },
  templates: {
  ...
  tasks: {
    ...
    startBidOpportunityParse: (payload) => ipcRenderer.invoke('tasks:start-bid-opportunity-parse', payload),
    startBidOpportunityScore: (payload) => ipcRenderer.invoke('tasks:start-bid-opportunity-score', payload),
    startBidOpportunityPrice: (payload) => ipcRenderer.invoke('tasks:start-bid-opportunity-price', payload),
    startBidImprovementPolish: (payload) => ipcRenderer.invoke('tasks:start-bid-improvement-polish', payload),
