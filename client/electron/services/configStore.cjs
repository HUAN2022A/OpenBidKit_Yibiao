...
function normalizeExportFormat(source) {
  ...
  const page = {
    ...
    header_right_text: typeof srcPage.header_right_text === 'string' ? srcPage.header_right_text : def.page.header_right_text,
    ...
    header_logo_enabled: typeof srcPage.header_logo_enabled === 'boolean' ? srcPage.header_logo_enabled : def.page.header_logo_enabled,
    header_underline: typeof srcPage.header_underline === 'boolean' ? srcPage.header_underline : def.page.header_underline,
