...
export const EXPORT_LAYOUT_PRESETS: ExportLayoutPreset[] = [
  ...
  },
  {
    id: 'formal-bid',
    label: '正式投标格式',
    description: '提取自真实投标文件：A4、四周 2.2cm 边距、小四正文 1.5 倍行距、二号/三号/四号黑体标题。',
    page: {
      paper_size: 'a4',
      orientation: 'portrait',
      first_page_different: false,
    ...
    heading_border_min_heading_left_enabled: false,
    headings: [
      heading('黑体', '二号', '居中对齐', false, 17, 16.5, 2.4),
      heading('黑体', '三号', '两端对齐', false, 13, 13, 1.72),
      heading('黑体', '四号', '两端对齐', false, 13, 13, 1.72),
      heading('黑体', '小四', '两端对齐', false, 5, 5, 1.5),
      heading('黑体', '小四', '两端对齐', false, 4, 2, 1),
      heading('黑体', '小四', '两端对齐', false, 2, 0, 1),
    ],
    body_text: {
      font: '宋体',
      size: '小四',
